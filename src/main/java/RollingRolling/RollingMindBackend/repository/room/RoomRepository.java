...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    @Query(value = "SELECT r.idx, u.nickname, u.image, r.room_id, r.open, r.participation_request AS participationRequest, r.title, r.content, r.release_date AS releaseDate, r.template_type AS templateType, COUNT(p.room_id) AS participantsCount " +
        "FROM rooms r " +
    ...
    @Query(value = "SELECT r.idx, u.nickname, u.image, r.room_id, r.open, r.participation_request AS participationRequest, r.title, r.content, r.release_date AS releaseDate, r.template_type AS templateType, COUNT(p.room_id) AS participantsCount " +
            ...
            "GROUP BY r.idx, u.nickname, u.image, r.room_id, r.open, r.participation_request, r.title, r.content, r.release_date, r.template_type " +
            "ORDER BY participantsCount DESC", nativeQuery = true)
    List<HotRollingPaperResponse> findByTitleContaining(@Param("keyword")String keyword);
